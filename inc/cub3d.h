...
/*   Updated: 2025/07/06 08:29:22 by kben-tou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_config			*ft_new_config(t_container *content, int fd_file,
						char *dir, char *path);
void				configue_direction_parsing(t_container *content,
						char *direction, char *path);
void				check_rgb_format(char *str, t_container *content);
void				check_color_separator(char *color_form,
						t_container *content);
...
float				get_vector_dis(t_container *content, float nex_x,
						float nex_y);
void				get_the_smallest(t_ray *ray, float ray_angle,
						float player_angle);
...
int					is_map_covered_with_walls(int x, int y,
						t_container *content);
void				ft_texture_loading(t_container *content, t_sprite *spr);
void				put_texture_to_screen(t_container *content,
						t_sprite *spr);
void				draw_sprite_hands(t_container *content);
void				draw_ceilling_floor(t_container *content, t_ray ray,
						int i);
